...
def generateHasInterestData(n, m, x=25, y=5, z=5):
	...
	for i in range(1, n+1):
		...
		if coin == 1:
			...
			cypher_rel_hasInterest = "MATCH (e:Event),(i:Interest) WHERE e.event_id = {} AND i.interest_id = {} CREATE (e)-[r:hasInterest]->(i);".format(temp_user, temp_interest)
		else:		#User Interest
...
sql_file.close()
# generateUserData(25)
# generateGroupData(5, 25)
# generateInterestData(10)				#max 473
# generateEventData(10, 25, 5)
# generatePostData(25)
# generateIsMemberData(30, 25, 5)
# generateIsFriendsWithData(50, 25)
# generateLeavesCommentData(50, 25, 25)
# generateHasInterestData(100, 25, 5, 10)